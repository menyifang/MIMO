...
if __name__ == '__main__':
    vid_path = '/mnt/workspace/myf272609/qingyao/mycode/Moore-AnimateAnyone-0130/assets/test_motion_0730/_b0ZK5w4NhU&list=LL&index=13.mp4'
    ...
    with torch.inference_mode(), torch.autocast("cuda", dtype=torch.bfloat16):
        ...
        imageio.mimsave('res.mp4', frames_mask, fps=30, quality=8, macro_block_size=1)
        imageio.mimsave('res_vis.mp4', frames_mask_vis, fps=30, quality=8, macro_block_size=1)
